#####
#Author: LordCasser
# Date: 2020-03-27 17:59:56
#LastEditTime: 2020-03-27 20:40:38
...
class Swap(object):
    ...
    def __ne__(s, o): return s != o
    def __gt__(s, o): return not s < o and s != o
    ...
    def read_swap(self):
        ...
        name = tfile.name
        cmd = u'{0} -X -u NONE -r -c"w! {1}|q" {2}'.format(
            EDITOR, name, self.swap)
    ...
    for file_name in swaps.keys():
        ...
        while sws:
            ...
            try:
                ...
                print(u'Skipping {0}: {1} exited with error code {2}'.format(
                    swap, EDITOR, unicode(e.exit)))
                continue
